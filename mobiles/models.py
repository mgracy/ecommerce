...
class ProductDetail(models.Model):
	...
	extend the information contained in the ``Product`` model with specific,
	extra details.
	'''
...
class ProductAttribute(models.Model):
	...
	across a set of products. It does not store any data values related
	to the attribute, but only describes what kind of a product feature 
	we are trying to capture. Possible attributes include things such
